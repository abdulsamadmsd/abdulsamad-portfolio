    ...
    <section id="about" className="relative py-24 sm:py-32">
      <div className="mx-auto max-w-7xl container-px">
        ...
        <div className="grid lg:grid-cols-[1.4fr_1fr] gap-12 lg:gap-16 items-start">
          ...
          >
            <p>
              I'm a <span className="text-foreground font-medium">Frontend Developer</span> focused on building
              ...
              <span className="text-accent">TypeScript</span>, transforming ideas into clean, efficient, and
              responsive interfaces.
            </p>
            <p>
              I have hands-on experience building real-world projects — including e-commerce platforms,
              dashboards, and management systems — with a strong focus on{" "}
              <span className="text-foreground">performance</span>, reusable component architecture, and
              seamless user experience.
            </p>
            <p>
              I'm passionate about continuous learning and problem-solving, always aiming to craft high-quality,
              impactful digital experiences. Let's connect and build something great together.
            </p>

            <div className="grid sm:grid-cols-2 gap-4 pt-6">
              <motion.div
                whileHover={{ y: -4 }}
                className="glow-border rounded-2xl bg-gradient-card p-5 shadow-card"
              >
                ...
                <p className="text-sm text-muted-foreground mt-1">Gomal University</p>
                <p className="font-mono text-xs text-muted-foreground/70 mt-1">4 Years Program</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-sm text-muted-foreground mt-1">Invincible Technology, Islamabad</p>
                <p className="font-mono text-xs text-muted-foreground/70 mt-1">Sep 2024 – Present</p>
              </motion.div>
            </div>
          </motion.div>
